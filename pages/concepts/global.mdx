# Global
Global data is accessible in every template (Next.js component) in your site and can be configured for a theme. You can define the "schema" of this data in the ```public/data/content-types/global``` file of your theme, like this:

```json filename="public/data/content-types/global.json" copy
{
  "global": {
    "fields": {
      "name": {
...
```tsx filename="components/templates/headers/header1.tsx" copy
