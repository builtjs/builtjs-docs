...
The data types available for a Built.js [Content Type](/concepts/content-type) are all the [common data-types](/concepts/data-types-common) plus the following:
...
| relation | `oneToOne` or `manyToOne`        | true     |
