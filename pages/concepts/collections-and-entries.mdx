...
```json filename="components/templates/cards/profile-cards1/profile-cards1.tsx" copy
...
```json filename="components/templates/articles/profile-article1/profile-article1.tsx" copy
import Image from "next/image";
