...
Article When you export a Theme or Plugin, by default, the layout will be a simple header and footer with the main content between. You can see this in the exported theme/plugin's ```public/data/layout.json```:
...
```tsx filename="components/layout/layout.js" copy
