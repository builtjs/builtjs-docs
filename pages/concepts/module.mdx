...
If the module is in a theme, you can now add the module to the ```theme.json``` data file:
...
If the module is for a plugin, you should add it to the ```plugin.json``` data file instead.

To learn more about how the core components of a Built.js theme or plugin related to each other, check out the [Data Model Reference](/data-model-reference).