...
### How it works:
Built.js uses configuration files and JSON schemas to set up themes and plugins. These configurations are central to defining the behavior, structure and content management system of a theme or plugin.
