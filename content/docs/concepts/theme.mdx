...
Code: [https://github.com/richjava/builtjs-theme-corporate](https://github.com/richjava/builtjs-theme-corporate)<br/>
...
The data model is outlined in [How Built.js works](/docs/concepts/concepts-overview). More information about this can be found in the [Data Model Reference](/data-model-reference).
