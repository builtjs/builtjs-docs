...
- It is defined with [data files](/docs/concepts/data-files)
...
- provider ("gh" for Github, "gl" for Gitlab, and "bb" for Bitbucket)
- owner
- repo name
```[provider]-[owner]-[repo-name]```
...
For example, in the "gh_richjava_blog" plugin, for a React component that is located at ```components/plugins/gh_richjava_blog/templates/lists/list2/list2.tsx```, when the end user of the theme exports it, the "List2" component is built into the home page of the site as ```GhRichjavaBlogList2```, like this:
...
{
  "theme": {
    "namespace": "gh_richjava_builtjs-theme-corporate",
    "title": "Corporate",
    ...
    "plugins": ["gh_richjava_builtjs-plugin-blog"],
    "config": {
      "dependencies": [],
      "devDependencies": []
    }
